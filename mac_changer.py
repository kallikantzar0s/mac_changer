...
def get_arguments():
	...
	if not options.interface:
		parser.error("[-] Specify interface or use --help for help")
	elif not options.new_mac_addr:
		parser.error("[-] Specify MAC addr or use --help for help")
	return options
...
mac_change(options.interface, options.new_mac_addr)
